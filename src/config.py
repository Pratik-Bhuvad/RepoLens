...
def parser_config():
    ...
    parser.add_argument("-ms","--min_stars", default=min_stars, type=int, help="Filter repositories by minimum number of stars.")
    parser.add_argument("-mx","--max_stars", default=max_stars, type=int, help="Filter repositories by maximum number of stars.")
